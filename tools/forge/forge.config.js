...
module.exports = {
  ...
  packagerConfig: {
    ...
    asar: true,
    // Set executable name
    executableName: "TermFTP",
    // Set application copyright
    appCopyright: "Copyright (C) TermFTP",
  ...
  plugins: [
    {
      ...
      config: {
        ...
        devContentSecurityPolicy: `default-src 'self' localhost:* ws: ; style-src 'self' 'unsafe-inline'; img-src 'self' data:; font-src 'self' data:`,
        // Ports
